...
def new_class(name, location, weekday, hour, minute, hour_d, minute_d, count):
    ...
    event.add("rrule", {"freq": "daily", "interval": 7, "count": count})

    return event


cal.add_component(new_class("Mechanics", "4G.2A", 0, 16, 0, 1, 30, 16))
cal.add_component(new_class("Mechanics", "4G.2A", 2, 16, 0, 1, 30, 15))
cal.add_component(new_class("Mechanics", "7A.9", 3, 11, 30, 2, 0, 15))
